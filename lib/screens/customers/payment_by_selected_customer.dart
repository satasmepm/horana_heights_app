...
import 'package:horana_heights/screens/customers/payment_details_by_selected_customer.dart';
...
class SelectedCustomerPaymentScreen extends StatelessWidget {
  final String nic;
  final int home_id;

  const SelectedCustomerPaymentScreen(
      {Key? key, required this.nic, required this.home_id})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder<List<PaymentModel>>(
          stream: PaymentController().fetchPayments(nic, home_id.toString()),
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageTransition(
                                ...
                                child: SelectedCustomerPaymentDetailsScreen(
