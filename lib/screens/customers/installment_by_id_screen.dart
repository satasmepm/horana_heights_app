...
import 'package:horana_heights/screens/customers/payment_by_selected_customer.dart';
...
class InstallmentByID extends StatefulWidget {
  final int home_id;
  final int cus_id;
  final String cus_nic;
  final AsignHomeModel asignHomeModel;
  InstallmentByID(
      {Key? key,
      required this.home_id,
      required this.cus_id,
      required this.cus_nic,
      required this.asignHomeModel})
      : super(key: key);

  @override
  State<InstallmentByID> createState() => _InstallmentByIDState();
}

class _InstallmentByIDState extends State<InstallmentByID> {
            ...
            child: Align(
              child: SlideInDown(
                child: Container(
                  ...
                  child: widget.asignHomeModel != null
                      ? Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: StreamBuilder<dynamic>(
                            stream: _userService.fetchHomeCardData(
                                widget.cus_nic, widget.home_id, widget.cus_id),
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        if (widget.asignHomeModel != null)
                                          if (widget
                                                  .asignHomeModel.types.id ==
                                              1)
                                            CustomBadge(
                                                widget.asignHomeModel.types
                                                    .ps_type,
                                                Colors.green)
                                          else if (widget.asignHomeModel.types.id ==
                                              2)
                                            CustomBadge(
                                                widget.asignHomeModel.types
                                                    .ps_type,
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              PageTransition(
                                  ...
                                  child: SelectedCustomerPaymentScreen(
                                    nic: widget.cus_nic,
                        ...
                        ? Container(
                            child: StreamBuilder<List<dynamic>>(
                              stream: PaymentController()
                                  .fetchInstallemetByHome(widget.cus_nic,
                                      widget.asignHomeModel.home.id.toString()),
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          LeadingIcon(
                              Color.fromARGB(255, 211, 252, 214),
